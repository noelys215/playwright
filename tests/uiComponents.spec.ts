...
test("web tables", async ({ page }) => {
  ...
  await page.locator("input-editor").getByPlaceholder("Age").fill("69");
  ...
  await expect(targetRowById.locator("td").nth(5)).toHaveText("test@test.edu");

  // test filters on the table
